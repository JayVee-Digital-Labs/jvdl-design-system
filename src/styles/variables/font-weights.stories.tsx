...
export default {
  ...
  parameters: {
    docs: {
      description: {
        story: 'This story showcases the different font weights available in the design system.',
      },
    },
  },
} as Meta;
...
const Template: StoryFn = () => (
  <div>
    ...
    <p className="font-weight-extra-bold">Extra Large Text - font-weight-extra-bold</p>
  </div>
);
