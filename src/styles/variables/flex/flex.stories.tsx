...
export default {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story showcases the different flex alignment classes available in the design system.'
      }
    }
  }
} as Meta;
...
const Template: StoryFn = () => (
  <div>
    ...
    <div
      className='flex flex-align-left'
      style={{
        border: '1px solid black',
        padding: '10px',
        marginBottom: '10px'
    ...
    <div
      ...
      style={{ border: '1px solid black', padding: '10px', height: '100px' }}>
