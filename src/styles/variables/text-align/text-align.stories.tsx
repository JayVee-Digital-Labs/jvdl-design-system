...
export default {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story showcases the different text alignment classes available in the design system.'
      }
    }
  }
} as Meta;
...
const Template: StoryFn = () => (
  <div>
    ...
    <div
      ...
      <p>
        Text Justified. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
